...
/**
 * Created by Mr.Z on 2016/10/12 0012.
 */
...
public class GameView extends GridLayout {
    ...
    private void checkComplete() {
        ...
        if (complete) {
            new AlertDialog.Builder(getContext()).setMessage("游戏结束").setPositiveButton("重试", new DialogInterface.OnClickListener() {
